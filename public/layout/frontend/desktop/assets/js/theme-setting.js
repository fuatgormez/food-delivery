...
$("#darkButton").on("click", function () {
  ...
  document
    ...
    .setAttribute("href", "./public/layout/frontend/assets/css/dark.css");
});
...
$("#lightButton").on("click", function () {
  ...
  document
    .getElementById("color-link")
    .setAttribute("href", "./public/layout/frontend/assets/css/style.css");
  console;
});
...
$(".rtl").on("click", function () {
  if ($("body").hasClass("ltr")) {
    ...
    $("#rtl-link").attr(
      "href",
      "./public/layout/frontend/assets/css/vendors/bootstrap.rtl.css"
    );
  } else {
    $("html").attr("dir", "");
    ...
    $("#rtl-link").attr(
      "href",
      "./public/layout/frontend/assets/css/vendors/bootstrap.css"
    );
  }
});
