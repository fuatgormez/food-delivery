                                ...
                                <div class="col-sm-8 m-auto">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <?php echo form_open_multipart(base_url('backend/shop-variant-item/add')) ;?>
                                                <div class="mb-4 row align-items-center">
                                                    <label class="form-label-title col-sm-3 mb-0" for="variant_item_name">Variant Item Name</label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control" name="name" id="variant_item_name" type="text" placeholder="Variant Item Name" required>
                                                    </div>
                                                </div>
                                                <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    <div class="form-group col-sm-12">
                                                        <button type="submit" class="btn btn-primary w-100 h-100" name="variant_item_add" title="">Add</button>
                                                    </div>
                                                </div>
                                            <?php echo form_close();?>
                                        </div>
