...
<head>
    ...
    <style type="text/css">
        ...
        .footer-table::before {
            position: absolute;
            content: "";
            background-image: url(public/layout/email/images/footer-left.svg);
        ...
        .footer-table::after {
            position: absolute;
            content: "";
            background-image: url(public/layout/email/images/footer-right.svg);
            background-position: top right;
            top: 0;
            right: 0;
            width: 100%;
                ...
                <td>
                    <table class="header-table" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr class="header"
                            ...
                            <td class="header-logo" style="padding: 10px 32px;">
                                <a href="<?php echo base_url();?>" style="display: block; text-align: left;">
                                    <img src="<?php echo base_url('public/uploads/'.$setting['logo']);?>" height="40" class="main-logo" alt="<?php echo $setting['site_name'];?>">
                                </a>
                            </td>
                            <td class="header-menu" style="display: block; padding: 10px 32px;text-align: right;">
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo base_url('checkout');?>">My Cart</a>
                                    </li>
                                    <li>
                    ...
                    <table class="contant-table" style="margin-top: 40px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr>
                                <td>
                                    <img src="<?php echo base_url('public/layout/email/images/reset.png');?>" alt="">
                                </td>
                            </tr>
                        </thead>
                    </table>
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <span style="font-weight: 500; font-size: 20px; margin: 0;">***This is an automatically generated email, please do not reply.***</span>
                                </td>
                                <td style="display: block;">
                                    <h3 style="font-weight: 700; font-size: 20px; margin-top: 100px;">Reset Password</h3>
                                </td>

                                <td style="display: block;">
                                    <h3
                                        style="font-weight: 700; font-size: 20px; margin: 0;color: #939393;margin-top: 15px;">
                                        Hi <?php echo $customer['firstname'];?>,</h3>
                                </td>
                                ...
                                <td>
                                    <p style="font-size: 17px;font-weight: 600;width: 74%;margin: 8px auto 0;line-height: 1.5;color: #939393;">
                                        ...
                                        Please enter the following verification code to access your <?php echo $setting['site_name'];?> Account.</p>
                                </td>
                            </tr>
                        </thead>
                    </table>
                    ...
                    <table class="button-table" style="margin-top: 27px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <button class="password-button"><?php echo $reset_code;?></button>
                                </td>
                            </tr>
                        </thead>
                    </table>
                    ...
                    <table class="button-table" style="margin-top: 27px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <p>The request for this access originated from IP address 84.158.135.45.</p>
                                </td>
                            </tr>
                        </thead>
                    </table>
                    ...
                    <table class="text-center footer-table" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td>
                                    ...
                                    <tr>
                                        <td>
                                            <h4 style="font-size: 19px; font-weight: 700; margin: 0;">Shop For <span
                                                    class="theme-color"><?php echo $setting['site_name'];?></span></h4>
                                        </td>
                                    </tr>
                                </table>
                                <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon text-center"
                                    ...
                                    <tr>
                                        <td>
                                            <a href="www.facebook.com">
                                                <img src="<?php echo base_url('public/layout/email/images/');?>images/fb.png"
                                        ...
                                        <td>
                                            <a href="www.twitter.com">
                                                <img src="<?php echo base_url('public/layout/email/images/');?>images/twitter.png"
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);"
                                                    alt="">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="www.instagram.com">
                                                <img src="<?php echo base_url('public/layout/email/images/');?>images/insta.png"
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);"
                                                    alt="">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="www.pinterest.com">
                                                <img src="<?php echo base_url('public/layout/email/images/');?>images/pinterest.png"
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);"
                                                    alt="">
                                            </a>
                                        </td>
                                ...
                                letter-spacing:1px; font-weight: 500;"></h5>
                                            <h5 style="font-size: 13px; text-transform: uppercase; margin: 10px 0 0; color:#ddd;
                                letter-spacing:1px; font-weight: 500;">2023 copyright <?php echo $setting['site_name'];?></h5>
                                        </td>
                                    </tr>
                                </table>
                            </td>
