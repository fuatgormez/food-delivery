            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadscrumb-contain">
                        ...
                        <h3><?php echo $this->session->flashdata('verified');?></h3>
                        <nav>
                    ...
                    <div class="dashboard-left-sidebar">
                        ...
                        <div class="profile-box">
                            <div class="cover-image">
                                <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/inner-page/cover-img.jpg');?>" class="img-fluid blur-up lazyload" alt="">
                            </div>

                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/inner-page/user/1.jpg');?>"
                                    ...
                                    <div class="title">
                                        ...
                                        <span class="title-leaf">
                                            <svg class="icon-width bg-gray">
                                                <use xlink:href="<?php echo base_url('public/layout/frontend/desktop/assets/svg/leaf.svg#leaf');?>"></use>
                                            </svg>
                                        </span>
                                    </div>

                                    <div class="dashboard-user-name">
                                        <h6 class="text-content">Hello, <b class="text-title"><?php echo $customer['firstname'];?></b></h6>
                                        ...
                                        <div class="row g-sm-4 g-3">
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/svg/order.svg');?>"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/svg/order.svg');?>" class="blur-up lazyload"
                                                        alt="">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/svg/pending.svg');?>"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/svg/pending.svg');?>" class="blur-up lazyload"
                                                        alt="">
                                                    <div class="totle-detail">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/svg/wishlist.svg');?>"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/svg/wishlist.svg');?>"
                                ...
                                <div class="dashboard-order">
                                    ...
                                    <div class="order-contain">
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/vegetable/product/2.png');?>" alt=""
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/vegetable/product/3.png');?>" alt=""
                                                        class="blur-up lazyload">
                                                </a>
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/vegetable/product/4.png');?>"
                                                        class="blur-up lazyload" alt="">
                                                </a>
                                        ...
                                        <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6">
                                            <div class="address-box">
                                                        ...
                                                        <table class="table">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>Address</td>
                                                                    <td>
                                                                        <p><?php echo $row['street'].' '. $row['street_no'] .', '. $row['postcode'];?></p>
                                                ...
                                                <div class="button-group">
                                                    <a class="btn btn-sm add-button btn-warning w-100 open_address_modal" data-id="<?php echo $row['id'];?>" data-bs-toggle="modal"
                                                        data-bs-target="#editProfile"><i data-feather="edit"></i>
                                                        Edit</a>
                                                    <a class="btn btn-sm btn-danger add-button w-100 delete_address" data-id="<?php echo $row['id'];?>"><i data-feather="trash-2"></i>
                                                        Remove</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="dashboard-profile">
                                    ...
                                    <div class="profile-about dashboard-bg-box">
                                        <div class="row">
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            <tr>
                                                                <td>Email :</td>
                                                                <td>
                                                                    <a href="javascript:void(0)"><?php echo $customer['email'];?>
                                            ...
                                            <div class="col-xxl-5">
                                                <div class="profile-image">
                                                    <img src="<?php echo base_url('public/layout/frontend/desktop/assets/images/inner-page/dashboard-profile.png');?>"
                            ...
                            <div class="tab-pane fade show" id="pills-security" role="tabpanel"
                                ...
                                <div class="dashboard-privacy">
                                    <div class="dashboard-bg-box">
                                        ...
                                        <button class="btn theme-bg-color btn-md fw-bold mt-4 text-white">Save Changes</button>
                                    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-floating mb-4 theme-form-floating">
                                    <input type="text" class="form-control" id="street_no" placeholder="Enter Street no">
                                    <label for="street_no">Street No</label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-floating mb-4 theme-form-floating">
                                    <input type="text" class="form-control" id="floor" placeholder="Enter floor">
                            ...
                            <div class="col-md-5">
                                <div class="form-floating mb-4 theme-form-floating">
                                    <input type="text" class="form-control" id="city" value="Berlin" disabled>
                                    <label for="city">City</label>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-floating mb-4 theme-form-floating">
                                    <input type="text" class="form-control" id="country" value="Deutschland" disabled>
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn theme-bg-color btn-md text-white save_customer_address" data-id="">Save changes</a>
                </div>
            </div>
        </div>
    </div>
